      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
        <div>
          ...
          <div className="flex gap-8 mt-6 text-accent font-bold">
            <div className='text-4xl text-[#FFC105]'>150+<br /><span className="text-sm font-normal text-gray-600">Projects Delivered</span></div>
            <div  className='text-4xl text-[#FFC105]'>98%<br /><span className="text-sm font-normal text-gray-600">Client Satisfaction</span></div>
          </div>
        </div>
