...
const founders = [
  {
    ...
    image:
      "https://cdn4.iconfinder.com/data/icons/developer-2/100/developer-solid-2-17-512.png",
    quote:
    ...
    <section className="py-20 px-4 bg-white text-gray-800">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 max-w-2xl mx-auto">
          Visionary leadership driving innovation and excellence in every
      ...
      <div className="max-w-4xl mx-auto mt-12 ">
        <div className="border-2 border-gray-400 rounded-2xl p-3">
          ...
          <p>
            ...
            solutions that combine aesthetic excellence with functional
            superiority. We believe that great software should be both powerful
            and beautiful.
          </p>
